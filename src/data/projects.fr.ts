...
export const projects = [
    ...
    },
    {
        ...
        year: '2024',
        description: 'Application web qui améliore le service en restauration via des QR codes, permettant aux clients de consulter le menu et de passer des commandes.',
